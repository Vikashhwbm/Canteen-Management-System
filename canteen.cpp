...
{
 cout<<"\n\n";
 cout <<"__JIS COLLEGE OF ENGINEERING__\t\t\t\t\t\t\t A PROJECT BY\n\n";
 cout <<"___Canteen Management System___\t\t\t\t\t\t1.HAOBAM VIKASH SINGH 123211003062\n";
 cout <<"Here choose an option\t\t\t\t\t\t\t2.Deepnarayan Patra 123211003055\n";
cout <<"1.BUY AN ITEM\t\t\t\t\t\t\t\t3.HARSH SINGH 123211003064\n";
cout <<"2.MENU CARD\t\t\t\t\t\t\t\t4.Dinesh Pal 123211003058\n";
cout <<"3.ADD NEW ITEM\t\t\t\t\t\t\t\t5.Debanjan Paria 123211003051\n";
 cout <<"4.EXIT \t\t\t\t\t\t\t\t\t__CSE(2A,3rd Semester)__ \n\n";
 cout <<"\t\t\t\t\t\t\t\t\t\tFor PR391\n";
 cout<<"----------------------------------------------------------\n";
...
void Mess::allItems()
{
 ...
 cout<<"2:RICE       | 30 Rs. per plate\n";
 cout<<"3.DAL        | 20 Rs. per plate\n";
 cout<<"4.ALOO MATAR | 40 Rs. per plate\n";
 cout<<"5.PANEER     | 50 Rs. per plate\n";
 cout<<"6.CHICKEN      | 60 Rs. per piece\n";
 cout<<"___________________________________\n";
 cout<<"____Today's SPECIAL Menu____\n\n";
 cout<<"7.BIRYANI    | 110 Rs. per plate\n";
 cout<<"__________________________________\n";
 Sleep(7000);
 system("cls");
}
